...
struct JlPythia8_EPAexternal: public Wrapper {
  ...
  void add_methods() const{
    ...
    t.constructor<int, double, Pythia8::PDFPtr, Pythia8::PDFPtr, Pythia8::Info *>(/*finalize=*/jlcxx::finalize_policy::yes);
    t.constructor<int, double, Pythia8::PDFPtr, Pythia8::PDFPtr, Pythia8::Info *, Pythia8::Logger *>(/*finalize=*/jlcxx::finalize_policy::yes);
