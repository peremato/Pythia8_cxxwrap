...
struct JlPythia8_PomHISASD: public Wrapper {
  ...
  void add_methods() const{
    ...
    t.constructor<int, Pythia8::PDFPtr, Pythia8::Settings &>(/*finalize=*/jlcxx::finalize_policy::yes);
    t.constructor<int, Pythia8::PDFPtr, Pythia8::Settings &, Pythia8::Logger *>(/*finalize=*/jlcxx::finalize_policy::yes);
