...
struct JlPythia8_EPPS16: public Wrapper {
  ...
  void add_methods() const{
    ...
    t.constructor<int, int, std::string, Pythia8::PDFPtr>(/*finalize=*/jlcxx::finalize_policy::yes);
    t.constructor<int, int, std::string, Pythia8::PDFPtr, Pythia8::Logger *>(/*finalize=*/jlcxx::finalize_policy::yes);
