...
struct JlPythia8_SingleCellJet: public Wrapper {
  ...
  void add_methods() const{
    ...
    t.constructor<double, double, double, double, double>(/*finalize=*/jlcxx::finalize_policy::yes);
    t.constructor<double, double, double, double, double, int>(/*finalize=*/jlcxx::finalize_policy::yes);
    t.constructor<double, double, double, double, double, int, Pythia8::Vec4>(/*finalize=*/jlcxx::finalize_policy::yes);
